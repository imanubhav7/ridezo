        ...
        >
            ...
            <h2 className="text-3xl sm:text-4xl font-black tracking-tighter text-zinc-900">
              ...
              <span className="relative inline-block =">
                ...
                <motion.div
                  ...
                  className="absolute -bottom-1 left-1 right-0 h-0.5 bg-zinc-900 origin-left"
                />
              </span>
            </h2>
          ...
          <div className="hidden sm:flex items-center gap-2">
            <motion.div
              whileTap={{ scale: 0.88 }}
              onClick={() => scroll("left")}
              className="h-11 w-11 rounded-2xl border border-zinc-200 bg-white flex items-center justify-center hover:bg-zinc-900 hover:text-white disabled:hover:bg-white disabled:hover:text-zinc-900 disabled:opacity-25 disabled:hover:border-zinc-200 transition-all text-zinc-700 shadow-sm"
            >
